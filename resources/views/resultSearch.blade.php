                ...
                <div class="container1 item">
                    <div class="listing-item">
                        ...
                        <form action="{{route('delete',$real->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                            <a class="deleteIcon"><button type="submit" class="servicedeletebtn" onclick="return confirm('Are you sure you want to Delete this Realestate ?')" id="Demo" style="border:none; background:none;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" color="yellow" style="margin-left: 10px;">
                        ...
                        <a href="{{url('liked/'.$real->id.'/')}}" class="addToFavoraite" style="margin-left:10px"><i data-product-id="{{$real->id}}"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16" color="#ee4c31">
                                <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>      
                                </svg>
                            </a>
                        </div>
